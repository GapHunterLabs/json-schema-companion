# Privacy Policy — JSON Schema Companion

**Effective date:** 2026-08-04

JSON Schema Companion is a Gap Hunter Labs plugin for IntelliJ Platform IDEs.
...
**Nothing.** JSON Schema Companion does not collect, store, transmit, or sell
...
**None.** JSON Schema Companion makes zero network calls during normal
...
None. JSON Schema Companion has no third-party SDKs, no analytics libraries,
