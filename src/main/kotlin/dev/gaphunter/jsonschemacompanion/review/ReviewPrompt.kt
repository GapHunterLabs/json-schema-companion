package dev.gaphunter.jsonschemacompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.jsonschemacompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.jsonschemacompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "JSON Schema Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33341-json-schema-companion/reviews"
